...
public class Pdpaula_website_parsing_ToJson {
    static List<Map<String,String>> allproduct=new ArrayList<>();
...
//			System.out.println(p);
		...
		String json=gson.toJson(allproduct);
		
		FileWriter fw=new FileWriter("C:\\Users\\hp\\Desktop\\product.json");
...
public static void productAllDetails(String url)
{
	try {
		...
		product.put("Product description",productDescription);
		product.put("Product Size",allSize);
		product.put("Product Material",productmaterail);
